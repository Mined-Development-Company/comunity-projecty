...
export function DonateCard() {
	...
	return (
		<section className="rounded-xl border border-content-shape-quaternary bg-content-shape-secondary p-4 sm:p-6">
			<h2 className="text-center text-lg font-semibold text-content-primary">
			...
			<button
				className="mt-4 w-full rounded-md bg-green-hard px-3 py-2 text-sm font-bold text-content-primary"
				type="button">
				Doar
			</button>
