	...
	return (
		<div
			...
			<div className="flex gap-3 self-stretch lg:self-auto">
				<Button
					variant="outline"
					className="flex-1 border-content-shape-quaternary bg-content-shape-secondary lg:flex-none">
					<Icon name="Books" /> Ver minhas perguntas
				</Button>
				<Button className="flex-1 lg:flex-none">
					<Icon name="Plus" weight="bold" className="text-white" /> Criar pergunta
				</Button>
			</div>
		</div>
	)
