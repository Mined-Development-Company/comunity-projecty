...
export function QuestionCard({
	...
	return (
		<article className="rounded-xl border border-content-shape-quaternary bg-content-shape-secondary p-5 shadow-sm transition-all duration-300 hover:scale-[101%]">
			<Link href={href}>
