...
export function SidebarFilter({ className, tags = defaultTags }: SidebarFilterProps) {
	return (
				...
				<div className="space-y-3">
					...
					<div className="flex flex-wrap gap-2">
						{tags.map((t) => (
							<button
								key={t}
								className="w-[56px] rounded-md border border-content-shape-quaternary bg-content-shape-secondary px-3 py-1.5 text-xs font-medium text-content-primary hover:bg-content-shape-quaternary">
								{t}
							</button>
						))}
					</div>
